...
Далее мы можем заметить, что задача очень похожа на ее более простой аналог — [Сумма двух чисел в массиве](/blog/two_sum/).
...
Осталось решить, что делать внутри второго цикла. А работа внутри него в целом сводится к задаче [Сумма двух чисел в массиве](/blog/two_sum/).
...
Теперь мы можем применить подход с двумя указателями, как в задаче [Сумма двух чисел в отсортированном массиве](/blog/two_sum_sorted_array/). 
Разница только в том, что нам надо найти все тройки, а их сумма всегда равно нулю.
...
Теперь мы можем полностью скопировать решение из задачи [Сумма двух чисел в отсортированном массиве](/blog/two_sum_sorted_array/) и немного его модифицировать.
